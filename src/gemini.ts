...
export const PROMPT_VERSION = 'v14'; // v14: BUY/SELL方向チェックを独立行に分離・sl≥entry(BUY)とsl≤entry(SELL)を最終チェックとして明示
