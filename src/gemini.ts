...
export const PROMPT_VERSION = 'v12'; // v12: SL上限違反（1.2円超: 1.24,1.5,2.0,2.4等）を全3モデルで明示禁止・安全範囲0.30〜0.80強化
...
export async function newsStage1(params: {
  ...
  const systemPrompt =
    ...
    '- 【SL距離の厳守・自動拒否回避】各銘柄名後の（）内のSL距離範囲を必ず守ること。例: USD/JPYは「SLは0.2〜1.2円」→ 下限違反: 0.199, 0.19, 0.18, 0.16, 0.13, 0.08（0.2未満のあらゆる値）は全て即自動拒否 / 上限違反: 1.24, 1.30, 1.50, 2.00, 2.40（1.2円を超えるあらゆる値）も全て即自動拒否。安全な範囲: 0.30〜0.80（迷ったらこの範囲で設定すること）\n' +
