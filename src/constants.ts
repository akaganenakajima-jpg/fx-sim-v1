...
// ─── 市場別DD閾値（AssetClass単位の独立DD管理） ─────────────────────────────────
/**
 * 各市場の割当資本は全体より小さいため、全体DDより厳しく設定。
 * 目的: ある市場（例: 日本株）でDD STOPしても、他市場（FX・暗号資産等）は通常営業を継続
 */
export const MARKET_DD_CAUTION  =  5;  // Half Kelly（市場別）
export const MARKET_DD_WARNING  =  7;  // Quarter Kelly（市場別）
export const MARKET_DD_HALT     = 10;  // Micro Kelly（市場別）
export const MARKET_DD_STOP     = 15;  // 市場別完全停止
